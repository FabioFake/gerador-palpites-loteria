...
fdescribe('MaisSorteadosGeradorProvaveisDezenasService', () => {
  ...
  fit('Deve retornar apenas as dezenas mais sorteadas', inject([MaisSorteadosGeradorProvaveisDezenasService],
    (service: MaisSorteadosGeradorProvaveisDezenasService) => {
